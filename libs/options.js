...
var parse = function(args,cb) {
    ...
    var optimist = require('optimist')
        .usage('Usage: secscan <fqdn|ipv4|cidr> [options]\n\nExample: secscan 192.168.0.0/24 --port=21-23,80')
        .demand('_')
    ...
    // like when using secscan with the command line
